...
// Test data from the user's background printout
const topic = "V5008Upload/2437871205/LabelState";
const hexMessage = "bb01ec3737bf0006020100dd354b740600dd344a44aa002744";
const message = Buffer.from(hexMessage, "hex");

console.log("Testing V5008 RFID with actual message from background:");
