...
CREATE TABLE IF NOT EXISTS sensor_data (
    ...
    mod_add INT, -- U-Sensor Module Modbus address, use this identify module address when device type is "V5008".
    mod_port INT, -- U-Sensor Module connected port number on a V6800 gateway device. use this identify module address when device type is "V6800".
